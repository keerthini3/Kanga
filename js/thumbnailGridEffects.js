(function() {
	...
	var allImages = {
		page1 : ['<a href="#"><div class="p-5 m-5"><p>Modafinil 200mg</p><p>MODVIGIL</p></div></a>','<a href="#"><img src="img/2.jpg" alt="img02"/></a>'],
		page2 : ['<a href="#"><div class="p-5 m-5"><p>Armodafinil Tablets</p><p>MODVIGIL</p></div></a>','<a href="#"><img src="img/8.jpg" alt="img08"/></a>'],
		page3 : ['<a href="#"><div class="p-5 m-5"><p>heading3</p><p>qwertyuio</p></div></a>','<a href="#"><img src="img/18.jpg" alt="img18"/></a>'],
		page4 : ['<a href="#"><div class="p-5 m-5"><p>heading4</p><p>qwertyuio</p></div></a>','<a href="#"><img src="img/14.jpg" alt="img14"/></a>']
	};
